...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/cus/pageQuery?currentPage=1&pageSize=10" data-title="客户资料" href="javascript:void(0)">客户资料</a></li>
		</dd>
	</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/acc/pageQuery?currentPage=1&pageSize=10" data-title="账户资料" href="javascript:void(0)">账户资料</a></li>
			</ul>
		</dd>
	</dl>
	<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/phone/pageQuery?currentPage=1&pageSize=10" data-title="客户资料" href="javascript:void(0)">客户资料</a></li>
			</ul>
		</dd>
	</dl>
</div>
