	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="150">呼叫号</th>
				<th width="150">被叫号</th>
				<th width="150">通话时长</th>
				<th width="100">话费</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${requestScope.pageBean.list}" var="bill">
			<tr class="text-c">
				<td><input type="checkbox" value="{bill.id}" name="" id="id"></td>
				<td>${bill.id}</td>
				<td>${bill.MUID}</td>
				<td><u style="cursor:pointer" class="text-primary" onclick="">${bill.CUID}</u></td>
				<td>${bill.callDuration}</td>
				<td>${bill.telephoneCharge}</td>
